...
<template>
  <main class="mx-auto w-full max-w-3xl flex-1 px-4 py-12 sm:px-6">
    <div class="relative mb-2 flex items-start justify-between gap-4">
      <div>
        <h1 class="text-3xl font-bold text-[var(--text)]">Terms of Service</h1>
        <p class="mt-2 text-sm text-[var(--muted)]">Last updated: May 2025</p>
      </div>
      <img
