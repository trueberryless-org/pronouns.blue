  ...
  <div class="mx-auto w-full max-w-6xl px-4 pb-8 sm:px-6">
    <main class="space-y-8">
      <div class="flex justify-center pb-2">
        <img src="/pronouns.blue.png" alt="pronouns.blue" width="966" height="396" class="h-auto w-auto max-h-60 max-w-full" loading="eager" />
      </div>
      <HomeUserSection />
