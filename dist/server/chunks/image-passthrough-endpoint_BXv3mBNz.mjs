...
import { o as removeQueryString, A as AstroError, N as NoImageMetadata, k as isRemoteAllowed, F as FailedToFetchRemoteImageDimensions, R as RemoteImageNotAllowed, m as joinPaths, E as ExpectedImage, l as isRemotePath, L as LocalImageUsedWrongly, g as MissingImageDimension, h as UnsupportedImageFormat, d as IncompatibleDescriptorOptions, U as UnsupportedImageConversion, a as ExpectedImageOptions, b as ExpectedNotESMImage, f as InvalidImageService, I as ImageMissingAlt, n as maybeRenderHead, i as addAttribute, u as spreadAttributes, t as renderTemplate, c as FontFamilyNotFound, v as unescapeHTML, M as MissingGetFontFileRequestUrl } from "./worker-entry_gMPfSA4_.mjs";
...
const baseService = {
  ...
  getRemoteSize(url, imageConfig2) {
    return inferRemoteSize(url, imageConfig2);
  }
};
...
async function getImage$1(options, imageConfig2) {
  ...
  if (resolvedOptions.inferSize) {
    ...
    if (isRemoteImage(resolvedOptions.src) && isRemotePath(resolvedOptions.src)) {
      ...
      const getRemoteSize = (url) => service.getRemoteSize?.(url, imageConfig2) ?? inferRemoteSize(url, imageConfig2);
  ...
  const initialImageURL = await service.getURL(validatedOptions, imageConfig2);
  ...
  let srcSets = await Promise.all(
    srcSetTransforms.map(async (srcSet) => {
      return {
        ...
        url: matchesValidatedTransform(srcSet.transform) ? initialImageURL : await service.getURL(srcSet.transform, imageConfig2),
...
async function peekRemoteFormatForStaticEmit(options, imageConfig2, service) {
  if (!isRemoteImage(options.src) || !isRemoteAllowed(options.src, imageConfig2) || !globalThis.astroAsset?.addStaticImage || !isLocalService(service) || !service.getRemoteSize) {
    return void 0;
  }
  try {
    const probed = await service.getRemoteSize(options.src, imageConfig2);
...
}, "/Users/trueberryless/repos/trueberryless-org/pronouns.blue/node_modules/.pnpm/astro@6.4.2_@types+node@24.12.2_tsx@4.21.0/node_modules/astro/components/Image.astro", void 0);
const mimes = {
  "3g2": "video/3gpp2",
  "3gp": "video/3gpp",
  "3gpp": "video/3gpp",
...
}, "/Users/trueberryless/repos/trueberryless-org/pronouns.blue/node_modules/.pnpm/astro@6.4.2_@types+node@24.12.2_tsx@4.21.0/node_modules/astro/components/Picture.astro", void 0);
...
}, "/Users/trueberryless/repos/trueberryless-org/pronouns.blue/node_modules/.pnpm/astro@6.4.2_@types+node@24.12.2_tsx@4.21.0/node_modules/astro/components/Font.astro", void 0);
...
const imageConfig = { "endpoint": { "route": "/_image", "entrypoint": "@astrojs/cloudflare/image-passthrough-endpoint" }, "service": { "entrypoint": "astro/assets/services/noop", "config": {} }, "dangerouslyProcessSVG": false, "domains": [], "remotePatterns": [], "responsiveStyles": false };
...
const page = () => _page;
const imagePassthroughEndpoint___js = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  page
}, Symbol.toStringTag, { value: "Module" }));
export {
  ...
  baseService as b,
  imagePassthroughEndpoint___js as i,
  verifyOptions as v
};
