...
import { U as renderTemplate, B as maybeRenderHead, a5 as addAttribute } from './params-and-props_CGkvChX8.mjs';
import { r as renderComponent } from './server_BDtFSrzz.mjs';
import { H as HeartIcon, $ as $$BaseLayout } from './HeartIcon_C3TPgyN_.mjs';
import { jsxs, jsx } from 'react/jsx-runtime';
import { useState, useEffect, useMemo } from 'react';
import { D as DEFAULT_LANG, g as getProfileRecordsFromPds } from './records_BqEqK-mF.mjs';
...
function TutorialTooltip({
  ...
  return /* @__PURE__ */ jsx("div", { className: "absolute bottom-full left-1/2 z-20 mb-2 -translate-x-1/2", children: /* @__PURE__ */ jsxs("div", { className: "animate-[fade-in-up_0.2s_ease-out_both]", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 whitespace-nowrap rounded-full bg-[var(--accent)] py-1 pl-3 pr-1.5 text-xs font-medium text-[var(--accent-contrast)] shadow-lg", children: [
      text,
      /* @__PURE__ */ jsx(
        "button",
        {
...
function EntryList({
  ...
  if (items.length === 0) {
    return /* @__PURE__ */ jsxs("p", { className: "border-b border-[var(--line)] py-3 text-sm text-[var(--muted)]", children: [
      "No ",
      label,
      " yet."
    ] });
  }
  return /* @__PURE__ */ jsx("ul", { children: items.map((item, index) => {
    ...
    return /* @__PURE__ */ jsxs(
      "li",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("span", { className: "flex-1 truncate text-base text-[var(--text)]", children: item }),
          /* @__PURE__ */ jsxs("div", { className: "flex flex-shrink-0 items-center gap-0.5", children: [
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              showHeartTip && /* @__PURE__ */ jsx(
                TutorialTooltip,
                {
              ...
              /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsx(HeartIcon, { filled: isPreferred, className: "h-4 w-4" })
                }
              )
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "relative flex items-center gap-0.5", children: [
              showArrowTip && /* @__PURE__ */ jsx(
                TutorialTooltip,
                {
                  text: "set the order",
                  onDismiss: () => onTutorialDismiss?.()
...
function LanguageSelector({
  ...
  if (customMode) {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-1.5", children: [
      ...
      check.status === "recognized" && /* @__PURE__ */ jsxs("span", { className: "text-xs text-[var(--muted)]", children: [
        "→ ",
        check.displayName
      ] }),
      check.status === "invalid" && /* @__PURE__ */ jsxs("span", { className: "text-xs text-[var(--danger)]", children: [
        check.msg,
        " · ",
        /* @__PURE__ */ jsx(
          "a",
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex items-center gap-1.5", children: /* @__PURE__ */ jsxs(
    "select",
    {
      value,
      onChange: (e) => {
      ...
      "aria-label": "Language",
      children: [
        availableOptions.map((l) => /* @__PURE__ */ jsx("option", { value: l.tag, children: l.label }, l.tag)),
        /* @__PURE__ */ jsx("option", { value: "__custom__", children: "Other (BCP-47)…" })
      ]
    }
  ) });
}
function LanguageGroupCard({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-[var(--border)] bg-[var(--surface-strong)] p-5", children: [
    /* @__PURE__ */ jsxs("div", { className: "mb-4 flex items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("span", { className: "text-xs font-medium uppercase tracking-wide text-[var(--muted)]", children: "Language" }),
        /* @__PURE__ */ jsx(
          LanguageSelector,
          {
            value: group.lang,
      ...
      !isEnglish || !isOnly ? /* @__PURE__ */ jsxs(
        "button",
        {
          type: "button",
          onClick: onRemove,
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid gap-6 md:grid-cols-2", children: [
      /* @__PURE__ */ jsxs("section", { children: [
        /* @__PURE__ */ jsx("h3", { className: "mb-1 text-base font-semibold text-[var(--text)]", children: "Names" }),
        isEnglish && /* @__PURE__ */ jsx("p", { className: "mb-3 text-sm text-[var(--muted)]", children: "Add one or more names — you can have as many as you like." }),
      ...
      /* @__PURE__ */ jsxs("section", { children: [
        /* @__PURE__ */ jsx("h3", { className: "mb-1 text-base font-semibold text-[var(--text)]", children: "Pronouns" }),
        isEnglish && /* @__PURE__ */ jsx("p", { className: "mb-3 text-sm text-[var(--muted)]", children: "Pick from common options or type your own." }),
        isEnglish && /* @__PURE__ */ jsx("div", { className: "mb-3 flex flex-wrap gap-2", children: COMMON_PRONOUNS.map((entry) => /* @__PURE__ */ jsx(
          "button",
          {
            type: "button",
...
function ProfileEditor({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
    isFirstTime && /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-[var(--border)] bg-[var(--surface-strong)] p-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-start", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex shrink-0 flex-col items-center gap-1.5", children: [
          /* @__PURE__ */ jsx("div", { className: "flex h-8 w-8 items-center justify-center rounded-full bg-[var(--accent)] text-sm font-bold text-[var(--accent-contrast)]", children: "✓" }),
          /* @__PURE__ */ jsx("span", { className: "text-xs font-medium text-[var(--text)]", children: "Sign in" })
        ] }),
        /* @__PURE__ */ jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex shrink-0 flex-col items-center gap-1.5", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-xs font-medium text-[var(--text)]", children: "Add your info" })
        ] }),
        /* @__PURE__ */ jsx(
          "div",
          {
      ...
      saved && profileHref && /* @__PURE__ */ jsxs("div", { className: "mt-4 flex flex-wrap items-center justify-between gap-3 border-t border-[var(--border)] pt-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-xl", children: "🎉" }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-[var(--text)]", children: "You're all set!" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-[var(--muted)]", children: "Your profile is live and ready to share." })
          ] })
        ] }),
        /* @__PURE__ */ jsxs(
          "a",
    ...
    groups.map((group, index) => /* @__PURE__ */ jsx(
      LanguageGroupCard,
      {
        group,
        usedLangs,
    ...
    error && /* @__PURE__ */ jsx("p", { className: "border-b border-[var(--line)] py-2 text-sm text-[var(--danger)]", children: error }),
    saved && !isFirstTime && /* @__PURE__ */ jsx("p", { className: "border-b border-[var(--line)] py-2 text-sm text-[var(--success)]", children: "Profile updated." }),
    /* @__PURE__ */ jsx(
      "button",
      {
        type: "button",
...
const $$Settings = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const did = getDid(Astro2.cookies);
  if (!did) return Astro2.redirect("/");
  ...
  const isFirstTime = profile.groups.length === 0 || profile.groups.every((g) => g.names.length === 0 && g.pronouns.length === 0);
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Settings – pronouns.blue" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="mx-auto w-full max-w-6xl px-4 pb-8 sm:px-6"> <section class="space-y-4 rounded-3xl border border-[var(--border)] bg-[var(--surface)] p-6"> <div class="flex flex-wrap items-start justify-between gap-3"> <div> <h1 class="text-2xl font-semibold text-[var(--text)]"> ${isFirstTime ? "Set up your profile" : "Settings"} </h1> <p class="text-sm text-[var(--muted)]"> ${isFirstTime ? "Add your names and pronouns to get started." : "Update your names and pronouns."} </p> </div> ${profileHref && renderTemplate`<a${addAttribute(profileHref, "href")} class="inline-flex items-center gap-2 rounded-full border border-[var(--border)] bg-[var(--surface-strong)] px-4 py-2 text-sm font-medium text-[var(--text)] hover:border-[var(--accent)] hover:text-[var(--accent)]"> <svg viewBox="0 0 24 24" class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"> <path d="M5 12h14"></path> <path d="m13 6 6 6-6 6"></path> </svg>
Show profile
</a>`} </div> ${renderComponent($$result2, "ProfileEditor", ProfileEditor, { "client:load": true, "initialGroups": profile.groups, "isFirstTime": isFirstTime, "profileHref": profileHref ?? void 0, "client:component-hydration": "load", "client:component-path": "@/components/ProfileEditor", "client:component-export": "ProfileEditor" })} </section> </main> ` })}`;
}, "/Users/trueberryless/repos/trueberryless-org/pronouns.blue/src/pages/settings.astro", void 0);

const $$file = "/Users/trueberryless/repos/trueberryless-org/pronouns.blue/src/pages/settings.astro";
const $$url = "/settings";
