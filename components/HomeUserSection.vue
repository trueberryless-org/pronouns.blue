...
<template>
  <section v-if="user" class="grid gap-4 md:grid-cols-2">
    <NuxtLink to="/settings" class="rounded-3xl border border-[var(--border)] bg-[var(--surface)] p-6 transition hover:border-[var(--accent)]">
    ...
    <NuxtLink :to="profileHref" class="rounded-3xl border border-[var(--border)] bg-[var(--surface)] p-6 transition hover:border-[var(--accent)]">
