...
<template>
  <svg viewBox="0 0 24 24" aria-hidden="true" :class="$props.class ?? ''" :fill="filled ? 'currentColor' : 'none'" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
