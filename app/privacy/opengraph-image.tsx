...
export const alt = "Privacy Policy – pronouns.blue";
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(136,57,239,0.22) 0%, transparent 65%)",
          }}
        />
        <div
          style={{
        ...
        >
          ...
          >
            How pronouns.blue handles your data — spoiler: we barely store any
          </div>
        </div>
